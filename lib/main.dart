...
class MyApp extends StatelessWidget {
  ...
  final List<PriceItemType> priceListItems = [
    ...
    PriceItemType(
        ...
        price: 1450,
        description:
            "Мы развиваем: Память — более 10 мнемотехник развития зрительной и слуховой памяти. Логику — умение видеть закономерности, делать выводы, решать логические задачи. Внимание — коцентрация, умение слышать педагога с первого раза. Гибкость - нестандартность мышления, стремление к экспериментам. Мышление — умение структурировать информацию. Речь — богатый словарный запас, умение красиво ищлагать свои мысли. Оба полушария головного мозга — всеми процессами в нашем организме управлет головной мозг и крайне важно улучшать эффективность его функцонирования. Так как каждому полушарию подчиняется противоположная рука, для развития одновременно обоих необзодимо выполнять специальные упражнения, в которых задейтвованы две руки, которые при этом выполняют действия независимо друг от друга.",
    ...
    PriceItemType(
        ...
        price: 1450,
        description:
            "Умение читать готвит детей к самостоятельной работе с текстом, его пониманию, а также прививает любовь к литературе. В ходе занятий дети научатся правильному чтению со скоростью до 50-60 слов в минуту. При этом развиваются внимание, мышление и все виды памяти.",
    ...
    PriceItemType(
        ...
        price: 1450,
        description:
            "Скорочтение — это способность быстрого восприятия текстовой информации при использовании особых способов чтения. При должном развитии навыка скорость может составлять до 600 слов в минуту. Мы обучаем методикам, позволяющим освоить скорочтение. Научим рациональному, эффективному и осмысленному чтению. Совершенствовуем технику и повышаем скорость чтения. Курс рекомендова как детям, так и взрослым",
    ...
    PriceItemType(
        ...
        price: 1450,
        description:
            "Мы готовим ребёнка к школе заранее! Занятия проходят в игровой форме и носят развивающий характер. В ходе занятий дети учатся не только чтению. У них формируется комплекс знаний об окружающем мире. Ребёнок приучается к работе в коллективе, готовится к интеграции в школьную среду. Кроме того, рука ребёнка привыкает к письму, развивается его речь, навыки математики и логики. Мы не просто адаптируем ребёнка к обучению в школе, мы развиваем его мышление!",
